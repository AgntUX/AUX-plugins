...
// The ui-handlers/compose/component/out/index.html is read, base64-encoded,
// and substituted in-place inside the compiled JS. The CI guard
// scripts/check-bundle-sync.mjs fails the build if the embed is stale.
//
// At runtime, ui-resources.ts reads the (substituted) base64 and decodes it
// when the host requests `resources/read` on `ui://gmail-compose`.
// =============================================================================

export const COMPOSE_UI_NAME = "gmail-compose" as const;
export const COMPOSE_RESOURCE_URI = "ui://gmail-compose" as const;
...
// NOT by the resource URI scheme ("gmail-compose"). The placeholder token must
...
export const gmailComposeBundleDescriptor = {
