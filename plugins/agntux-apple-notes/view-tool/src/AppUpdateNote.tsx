/**
 * AppUpdateNote.tsx — protocol bridge for the update-note handler.
 *
 * Bridges mcp-apps-kit hooks to UpdateNoteComponent's props interface.
 * Mirror of the canonical _template App.tsx — edit UpdateNoteComponent,
 * not this file.
 */
...
import { UpdateNoteComponent } from './components/update-note/UpdateNoteComponent.js';
import type { MainComponentProps } from './components/shared/MainComponentProps.js';

export function AppUpdateNote() {
