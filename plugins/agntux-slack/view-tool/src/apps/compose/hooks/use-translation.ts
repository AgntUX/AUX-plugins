...
// Pre-import all locales statically so Vite can bundle them. Triage v1 ships
// en-US only — additional locales can be added by dropping JSON files into
// `locales/{code}.json` and registering them in this map.
