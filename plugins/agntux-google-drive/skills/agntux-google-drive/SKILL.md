---
name: agntux-google-drive
description: The Google Drive command surface for AgntUX. Runs an ingest pass against Google Drive or answers natural-language questions about google-drive content live. Use for "/agntux-google-drive", "sync google-drive", "ingest google-drive now", "refresh google-drive", "fire a google-drive pass", "what's happening in #My Drive", "what's in my google-drive", "what did {person} say in google-drive this week", "summarise last week's {topic} thread", "any new threads about {project}", "any unread google-drive", or any Google Drive-scoped question.
...
# `/agntux-google-drive` — Google Drive command surface

Lane: single user-facing entry into the agntux-google-drive plugin. Read
the first whitespace-delimited token of `$ARGUMENTS`; route to the
right reference file.

## Voice rules

Speak as the Google Drive surface of AgntUX. Never reference
