...
- **Comment on the issue** — Reply with full formatting.
- **Move to a new state** — Transition between workflow states.
- **Reassign** — Move work between team members or self-assign.
- **Edit priority, labels, or summary** — Update any issue field.
- **Log work** — Record hours spent.
