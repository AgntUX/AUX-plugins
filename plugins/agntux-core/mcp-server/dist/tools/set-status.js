...
export function appendOutcomeSection(file, outcome, note) {
...
export const setStatusTool = {
    description: "Set the status of an action item (open, snoozed, done, or dismissed). Optionally captures user intent via `outcome` — `completed-externally`, `noise`, `irrelevant`, or any free-form string — appended as an `## Outcome` body section. pattern-feedback reads this to distinguish positive dismissals from negative.",
    inputSchema: {
        type: "object",
        properties: {
