...
const DEFAULT_DSN = "https://f1e209fbd00492b9601def0921c789c1@o4511633648975872.ingest.us.sentry.io/4511633995792384";
...
export const scrubString = (s) => String(s)
...
export const scrub = (v, seen = new WeakSet(), depth = 0) => {
    ...
    seen.add(v);
    if (Array.isArray(v))
        return v.map((x) => scrub(x, seen, depth + 1));
    const o = {};
