...
1. Identify which `~/agntux/actions/{id}.md` the prompt belongs to
...
3. Read `~/agntux/user.md` (`# Identity`, `# Glossary`, `# Auto-learned`).
...
1. Read `~/agntux/actions/{id}.md`. If it doesn't exist, say so in
