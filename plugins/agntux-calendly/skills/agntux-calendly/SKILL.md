---
name: agntux-calendly
description: The Calendly command surface for AgntUX. Runs an ingest pass against Calendly or answers natural-language questions about calendly content live. Use for "/agntux-calendly", "sync calendly", "ingest calendly now", "refresh calendly", "fire a calendly pass", "what's happening in #scheduled meeting", "what's in my calendly", "what did {person} say in calendly this week", "summarise last week's {topic} thread", "any new threads about {project}", "any unread calendly", or any Calendly-scoped question.
...
# `/agntux-calendly` — Calendly command surface

Lane: single user-facing entry into the agntux-calendly plugin. Read
the first whitespace-delimited token of `$ARGUMENTS`; route to the
right reference file.

## Voice rules

Speak as the Calendly surface of AgntUX. Never reference
