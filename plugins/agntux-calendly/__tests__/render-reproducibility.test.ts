/**
 * render-reproducibility.test.ts — agntux-calendly
 *
 * Lint-pass-8 mirror: asserts the committed rendered tree at
 * skills/agntux-calendly/ is byte-identical to what
 ...
 *
 * The renderer (renderSkill) is the consumed function from the consumer
 * repo's scripts/render-skill.mjs. The relative path navigates from the
 * plugin root up two levels to the monorepo root.
 */
