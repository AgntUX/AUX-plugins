/**
 * render-reproducibility.test.ts — agntux-canva
 *
 * Lint-pass-8 mirror: asserts the committed rendered tree at
 * skills/agntux-canva/ is byte-identical to what
 ...
 *
 * If a developer edits skills/agntux-canva/reference/cursor.md (or any
