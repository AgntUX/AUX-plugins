---
name: agntux-canva
description: The Canva command surface for AgntUX. Runs an ingest pass against Canva or answers natural-language questions about canva content live. Use for "/agntux-canva", "sync canva", "ingest canva now", "refresh canva", "fire a canva pass", "what's happening in #Brand Kit", "what's in my canva", "what did {person} say in canva this week", "summarise last week's {topic} thread", "any new threads about {project}", "any unread canva", or any Canva-scoped question.
...
# `/agntux-canva` — Canva command surface

Lane: single user-facing entry into the agntux-canva plugin. Read
the first whitespace-delimited token of `$ARGUMENTS`; route to the
right reference file.

## Voice rules

Speak as the Canva surface of AgntUX. Never reference
