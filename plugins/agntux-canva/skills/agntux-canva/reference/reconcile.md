...
the next run the world has moved: the Canva artefact may
...
to Canva. A re-check failure logs
`canva-reconcile-failed` and skips that candidate; Step 11's
