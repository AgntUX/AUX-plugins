/**
 * React context and provider for apps-react
 *
...
import type { AppsClient, ToolDefs } from '../apps-client/index.js';
import { createClient } from '../apps-client/index.js';
...
/**
 * Context provider for apps-react integration
 *
...
export function AppsProvider<T extends ToolDefs = ToolDefs>({
  ...
  const [client, setClient] = useState<AppsClient<T> | null>(
    providedClient ?? null,
  );
