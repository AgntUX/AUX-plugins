...
import { SubscriptionEditComponent, type MainComponentProps } from './apps/subscription-edit/components/SubscriptionEditComponent.js';
import './globals.css';

const VIEW_MIN_HEIGHT_PX = 500;
...
function App() {
  ...
  return (
    <div className="h-full">
      <ComponentErrorBoundary>
        <SubscriptionEditComponent {...props} />
      </ComponentErrorBoundary>
    </div>
  );
}
