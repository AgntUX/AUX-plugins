...
import { InvoiceFinalizeComponent, type MainComponentProps } from './apps/invoice-finalize/components/InvoiceFinalizeComponent.js';
import './globals.css';
...
function App() {
  ...
  return (
    <div className="h-full">
      <ComponentErrorBoundary>
        <InvoiceFinalizeComponent {...props} />
      </ComponentErrorBoundary>
    </div>
  );
}
