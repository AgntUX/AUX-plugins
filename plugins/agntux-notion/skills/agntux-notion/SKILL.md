---
name: agntux-notion
description: The Notion command surface for AgntUX. Runs an ingest pass against Notion or answers natural-language questions about notion content live. Use for "/agntux-notion", "sync notion", "ingest notion now", "refresh notion", "fire a notion pass", "what's happening in #Engineering Wiki", "what's in my notion", "what did {person} say in notion this week", "summarise last week's {topic} thread", "any new threads about {project}", "any unread notion", or any Notion-scoped question.
...
# `/agntux-notion` — Notion command surface

Lane: single user-facing entry into the agntux-notion plugin. Read
the first whitespace-delimited token of `$ARGUMENTS`; route to the
right reference file.

## Voice rules

Speak as the Notion surface of AgntUX. Never reference
