/**
 * CommentApp.tsx — Protocol bridge for the Notion comment-reply handler.
 * Cloned from the canonical _template App.tsx and retargeted for CommentMainComponent.
 */
...
import {
  ...
  type CommentMainComponentProps,
} from './CommentMainComponent.js';
...
export function CommentApp() {
  ...
  const props: CommentMainComponentProps = {
    toolInput,
