/**
 * CreateApp.tsx — Protocol bridge for the Notion create-page handler.
 * Cloned from the canonical _template App.tsx and retargeted for CreateMainComponent.
 */
...
import {
  CreateMainComponent,
  type CreateMainComponentProps,
} from './CreateMainComponent.js';
