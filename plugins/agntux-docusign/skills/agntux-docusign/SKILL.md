---
name: agntux-docusign
description: The DocuSign command surface for AgntUX. Runs an ingest pass against DocuSign or answers natural-language questions about docusign content live. Use for "/agntux-docusign", "sync docusign", "ingest docusign now", "refresh docusign", "fire a docusign pass", "what's happening in #contract", "what's in my docusign", "what did {person} say in docusign this week", "summarise last week's {topic} thread", "any new threads about {project}", "any unread docusign", or any DocuSign-scoped question.
...
# `/agntux-docusign` — DocuSign command surface

Lane: single user-facing entry into the agntux-docusign plugin. Read
the first whitespace-delimited token of `$ARGUMENTS`; route to the
right reference file.

## Voice rules

Speak as the DocuSign surface of AgntUX. Never reference
