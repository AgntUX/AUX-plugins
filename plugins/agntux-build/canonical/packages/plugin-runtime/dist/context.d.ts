 ...
 */
export type UpdatePatch = (current: string | null) => string | Promise<string>;
export interface ViewToolFs {
     ...
     */
    writeFile(path: string, body: Buffer | string, opts?: WriteFileOpts): Promise<WriteResult>;
    /**
...
export interface ViewTool<Args, Out> {
     ...
     */
    handle(args: Args, ctx: ViewToolContext): Promise<{
        content?: Array<{
            type: "text";
            text: string;
        }>;
...
export type ViewToolFsErrorCode = "not-found" | "forbidden" | "transient" | "schema" | "conflict";
/**
 ...
 */
export declare class ViewToolFsError extends Error {
 ...
 */
export declare function mergeScope(scope: Readonly<ViewToolScope>, extra: Partial<ViewToolScope>): Readonly<ViewToolScope>;
