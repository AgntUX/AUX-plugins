 ...
 *   - Modals (the legacy `ScrollableModal` is retired; modals don't
 *     anchor to the row the user clicked, and the host's
 *     height-overflow guard pushes them to roughly 1/3 down the iframe
 *     regardless of where the user is). See
 *     `canonical/prompts/ui/briefing-learnings.md` §2.4.
