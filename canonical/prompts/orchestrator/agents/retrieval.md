...
1. `~/agntux-code/user.md` — the user's identity, responsibilities, preferences, glossary, and auto-learned patterns. You speak in their voice and respect their preferences.
